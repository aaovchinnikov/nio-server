...
/**
 * Reads from socket until "exit" substring is reached
 */
public class LoggingReadUntilExitHandler implements CompletionHandler<Integer, ByteBuffer> {
	private final AsynchronousSocketChannel client;
	private final StringBuilder builder;
	private final Logger logger;
	
	public LoggingReadUntilExitHandler(AsynchronousSocketChannel client,
			StringBuilder builder, Logger logger) {
		this.client = client;
